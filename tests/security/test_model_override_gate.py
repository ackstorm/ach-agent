...
from ach_agent.boot.secrets import resolve_model_upstream
...
def test_no_override_returns_ach_defaults(monkeypatch):
    ...
    base, header, token = resolve_model_upstream("ek_live", "https://ach.example")
...
def test_override_without_degraded_flag_exits(monkeypatch):
    ...
    with pytest.raises(SystemExit) as exc:
        resolve_model_upstream("ek_live", "https://ach.example")
