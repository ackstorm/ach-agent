...
- Update the frozen prose contract `docs/plan/CONTRACT_v3.md`; no JSON-schema field changes are required.
...
| `docs/plan/CONTRACT_v3.md` | Frozen contract for identity sources, all four outbound paths, stripping, and metric labels. |
...
- Modify: `docs/plan/CONTRACT_v3.md:395-425,499-504,620-634,699-709`
...
Make these precise changes in `docs/plan/CONTRACT_v3.md`:
...
rg -n "x-ach-agent|x-ach-environment|every exposed sample|name\[\]|case-insensitive|v0.10.1" \
  docs/plan/CONTRACT_v3.md docs/configuration.md
...
```bash
git add docs/plan/CONTRACT_v3.md docs/configuration.md
