...
- [ ] Reject nonempty forwardEnv in split mode. Pass MCP templates with env references unresolved; mini-harness resolves against its own explicit environment. No runtime environment copied from harness wholesale in local mode either.
